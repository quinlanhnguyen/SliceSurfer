...
ImpulseRadialHeightForce::ImpulseRadialHeightForce(float magnitude) {
	this->magnitude = magnitude;
	applyOnce = true;
}

void ImpulseRadialHeightForce::updateForce(Particle* particle) {
...
void ImpulseRadialHeightForce::setHeight(float h) {
	height = h;
}

void ImpulseRadialHeightForce::setMagnitude(float m) {
	magnitude = m;
}